    ...
    const mockRoommates: Roommate[] = [
      {
        ...
        bio: 'Looking for a clean and quiet roommate. I study late and wake up early.',
      ...
      },
      {
        ...
        bio: 'Friendly and easy-going. Love to cook and share meals!',
      ...
      },
      {
        ...
        bio: 'Sports enthusiast, looking for someone who enjoys outdoor activities.',
          ...
          <>
            ...
            {rooms.length === 0 ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
                {rooms.map((room) => (
                  <div key={room._id} className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100 active:scale-[0.98]">
                    <div className="h-40 sm:h-48 bg-gradient-to-br from-blue-100 to-blue-200 border-b border-gray-200 w-full flex items-center justify-center relative">
                    ...
                    <div className="p-4 sm:p-5 md:p-6">
                      ...
                      <div className="mt-4 space-y-2 mb-4">
                        <div className="flex items-center text-sm text-gray-600">
                          ...
                          <span className="truncate">{room.distanceFromCollege}</span>
                        </div>
                      ...
                      <div className="mt-6 pt-4 border-t border-gray-200 flex justify-between items-center">
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-semibold text-gray-900 truncate">{room.owner.name}</p>
                          <a href={`tel:${room.owner.phone}`} className="text-sm text-primary-600 hover:text-primary-700">
                            📞 {room.owner.phone}
                          </a>
                        </div>
                        <button className="bg-primary-600 hover:bg-primary-700 active:bg-primary-800 text-white py-2.5 px-4 sm:px-5 rounded-xl font-semibold text-sm sm:text-base shadow-md hover:shadow-lg transition-all active:scale-95 ml-3">
                          Contact
                        </button>
                      </div>
                    </div>
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
              {roommates.map((roommate) => (
                <div key={roommate._id} className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100 active:scale-[0.98]">
                  <div className="h-32 sm:h-40 bg-gradient-to-br from-purple-100 to-purple-200 border-b border-gray-200 w-full flex items-center justify-center">
                  ...
                  <div className="p-4 sm:p-5 md:p-6">
                    <div className="text-center mb-4">
                      <h3 className="text-lg sm:text-xl font-bold text-gray-900">{roommate.name}</h3>
                      <p className="text-sm text-gray-600">{roommate.age} years • {roommate.gender}</p>
                      <p className="text-sm text-primary-600 font-semibold mt-1">{roommate.course} - {roommate.year}</p>
                    </div>
                    ...
                    <div className="space-y-2 mb-4">
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-medium text-gray-900">{roommate.preferences.foodHabit}</span>
                      </div>
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-gray-600">Schedule:</span>
                        <span className="font-medium text-gray-900">{roommate.preferences.sleepSchedule}</span>
                      </div>
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-gray-600">Cleanliness:</span>
                        <span className="font-medium text-gray-900">{roommate.preferences.cleanliness}</span>
                      </div>
                    </div>
